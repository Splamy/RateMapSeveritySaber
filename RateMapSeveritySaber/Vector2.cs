...
#pragma warning restore CS0661
	{
		...
		public static Vector2 operator *(Vector2 v1, SkalTyp s) => new(v1.X * s, v1.Y * s);
		...
		public readonly Vector2 Rotate(float angle) => new(
		...
		public readonly Vector2 Offset(SkalTyp val) => new(X + val, Y + val);

		public readonly Vector2 Offset(SkalTyp x, SkalTyp y) => new(X + x, Y + y);

		public readonly Vector2 Offset(Vector2 v1) => new(X + v1.X, Y + v1.Y);
